...
public class BemDAO {
    ...
    public List<Bem> pesquisarPorNome(String nome) {
        return em.createQuery("SELECT b FROM Bem b JOIN FETCH b.tipoProduto WHERE lower(b.nomeProduto) LIKE :nome ORDER BY b.nomeProduto", Bem.class)
